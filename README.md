...
**[v1.22.3](https://github.com/LuoDi-Nate/financial-management/releases/tag/v1.22.3) · 账户卡入口改回靠左**
纯样式小修正:v1.22.2 把账户卡上的三个入口改成靠右,实际不好看,改回默认的靠左。顺带删掉守着「必须靠右」的那条护栏 —— 它守的是一个偶然的美学判断,不是设计意图。**无 DB 迁移。**
