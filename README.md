...
| 测试 | JUnit 5 · 353 单元(含 PrivacyIsolationTest 静态扫源码私密红线 + CurrencyInvarianceTest 币种不变性 + AShareTicker 交易所前缀 + MetalUnit 贵金属单位/归一 + 单一镜头端到端币种守护)/ 49 e2e 断言(10 主线)/ 440 黑盒回归 |
