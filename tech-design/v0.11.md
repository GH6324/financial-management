...
FR-116 开关→决策 131 · FR-117 遮留范围→决策 127+覆盖清单 · FR-118 模糊+不可复制+定宽→决策 126 · FR-119 会话级→决策 128 · FR-120 指示→决策 131 · FR-121 图表→决策 130 · FR-122 截图安全→决策 126(DOM 即模糊)。

## 不做(本迭代)

服务端遮挡 / 账户名遮挡 / 设备持久化 / 长按 peek / 取证级隐藏 —— 均 PRD 非目标。
